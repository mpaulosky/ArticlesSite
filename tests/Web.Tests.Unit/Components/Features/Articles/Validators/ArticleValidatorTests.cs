...
namespace Web.Tests.Unit.Components.Features.Articles.Validators;
...
public class ArticleValidatorTests
{
	...
	public void Validate_WithValidArticle_ShouldPass()
	{
		...
		Article article = new("Test Article", "Test introduction", "Test content", "https://example.com/cover.jpg",
				new Web.Components.Features.AuthorInfo.Entities.AuthorInfo("auth0|123", "John Doe"),
	...
	{
		// Arrange - Use Article.Empty which has an empty slug
		Article article = Article.Empty;
	...
	{
		// Arrange - Since Slug is generated from title and is read-only, we test it with Article.Empty which has an empty slug
		Article article = Article.Empty;
