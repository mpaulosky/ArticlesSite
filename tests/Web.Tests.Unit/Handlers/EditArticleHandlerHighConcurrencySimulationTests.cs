...
public class EditArticleHandlerHighConcurrencySimulationTests
{
    ...
    public async Task HighConcurrency_SimulatedClients_AtLeastOneSucceeds_AndRetriesHappen()
    {
        ...
        {
            var dto = new ArticleDto(articleId, "original", $"Updated Title {i}", "Intro", "Updated Content", "https://example.com/img.jpg", null, null, false, null, null, DateTimeOffset.UtcNow, false, false, 0);
